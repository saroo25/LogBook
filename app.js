...
const coords = {
  first: {
    number: [56, 686, 13, 112],
    date: [467, 703, 9, 78],
    location: [122, 642, 10, 332],
    site: [122, 609, 10, 332],
    entryTime: [514, 642, 10, 62],
    exitTime: [514, 609, 10, 62],
    maxDepth: [122, 568, 10, 70],
    bottomTime: [361, 568, 10, 78],
    waterTemp: [514, 568, 10, 62],
    pressureIn: [122, 521, 10, 70],
    pressureOut: [361, 521, 10, 78],
    mix: [514, 521, 10, 62],
    weight: [122, 486, 10, 70],
    suit: [361, 486, 10, 78],
    visibility: [514, 486, 10, 70],
    notes: [58, 431, 9.5, 485, 5],
    buddySignature: [142, 350, 10, 190],
    centerStamp: [417, 350, 10, 130],
  },
  repeat: {
    number: [56, 768, 13, 112],
    date: [467, 749, 9, 78],
    location: [122, 708, 10, 332],
    site: [122, 676, 10, 332],
    entryTime: [514, 708, 10, 62],
    exitTime: [514, 676, 10, 62],
    maxDepth: [122, 631, 10, 70],
    bottomTime: [361, 631, 10, 78],
    waterTemp: [514, 631, 10, 62],
    pressureIn: [122, 586, 10, 70],
    pressureOut: [361, 586, 10, 78],
    mix: [514, 586, 10, 62],
    weight: [122, 552, 10, 70],
    suit: [361, 552, 10, 78],
    visibility: [514, 552, 10, 70],
    notes: [58, 497, 9.5, 485, 5],
    buddySignature: [142, 417, 10, 190],
    centerStamp: [417, 417, 10, 130],
  },
};
