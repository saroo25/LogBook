...
const coords = {
  first: {
    number: [56, 684, 13, 112],
    date: [467, 703, 9, 78],
    location: [122, 636, 10, 332],
    site: [122, 601, 10, 332],
    entryTime: [514, 636, 10, 62],
    exitTime: [514, 601, 10, 62],
    maxDepth: [122, 565, 10, 70],
    bottomTime: [361, 565, 10, 78],
    waterTemp: [514, 565, 10, 62],
    pressureIn: [122, 515, 10, 70],
    pressureOut: [361, 515, 10, 78],
    mix: [514, 515, 10, 62],
    weight: [122, 463, 10, 70],
    suit: [361, 463, 10, 78],
    visibility: [514, 463, 10, 70],
    notes: [58, 401, 9.5, 485, 5],
    buddySignature: [142, 313, 10, 190],
    centerStamp: [417, 313, 10, 130],
  },
  repeat: {
    number: [56, 766, 13, 112],
    date: [467, 749, 9, 78],
    location: [122, 682, 10, 332],
    site: [122, 647, 10, 332],
    entryTime: [514, 682, 10, 62],
    exitTime: [514, 647, 10, 62],
    maxDepth: [122, 612, 10, 70],
    bottomTime: [361, 612, 10, 78],
    waterTemp: [514, 612, 10, 62],
    pressureIn: [122, 561, 10, 70],
    pressureOut: [361, 561, 10, 78],
    mix: [514, 561, 10, 62],
    weight: [122, 509, 10, 70],
    suit: [361, 509, 10, 78],
    visibility: [514, 509, 10, 70],
    notes: [58, 447, 9.5, 485, 5],
    buddySignature: [142, 360, 10, 190],
    centerStamp: [417, 360, 10, 130],
  },
};
